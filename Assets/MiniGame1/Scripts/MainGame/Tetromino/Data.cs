...
namespace Minigame1
{
    public static class Data
    {
        ...
        public static readonly Dictionary<Tetromino, Vector2Int[]> Cells = new Dictionary<Tetromino, Vector2Int[]>()
        {
            ...
            { Tetromino.O, new Vector2Int[] { new Vector2Int( 0, 1), new Vector2Int( 0, 0) } },
            ...
            { Tetromino.Jump, new Vector2Int[] { new Vector2Int( 0, 1), new Vector2Int( 0, 0) } },
            { Tetromino.WalkThrough, new Vector2Int[] { new Vector2Int( 0, 1), new Vector2Int( 0, 0) } },
        };
        ...
        public static readonly Dictionary<Tetromino, Vector2Int[,]> WallKicks = new Dictionary<Tetromino, Vector2Int[,]>()
        {
            ...
            { Tetromino.Jump, WallKicksJLOSTZ },
            { Tetromino.WalkThrough, WallKicksJLOSTZ },
        };
